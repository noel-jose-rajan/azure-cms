...
export default class DWTEditBar extends Component<{
          ...
          <ul className="operateGrp">
            <li>
              <div
                ...
                onClick={() => this.clickbtnRemoveCurrentImage()}
              ></div>
            </li>
            <li>
              <div
                ...
                onClick={() => this.clickbtnRemoveAllImages()}
              ></div>
            </li>
            ...
            <li className="lblShowCurrentImage">
              <input
                ...
                readOnly={true}
              />
              /<input type="text" size={2} id="DW_TotalImage" readOnly={true} />
            </li>
              ...
              <ul>
                <li style={{ width: "25%" }}>
                  <div
                    ...
                    title="Zoom out"
                    id="btnZoomOut"
                    onClick={() => this.clickbtnZoomOut()}
                  ></div>
                </li>
                <li style={{ width: "50%" }}>
                  <input type="text" id="DW_spanZoom" readOnly={true} />
                </li>
                <li style={{ width: "25%" }}>
                  <div
            ...
            <li>
              ...
              <div
                ...
                id="btnFitWindow"
                style={{ display: "none" }}
                onClick={() => this.clickbtnFitWindow()}
              ></div>
            </li>
            ...
            <li>
              <div
                ...
                title="Rotate left"
                id="btnRotateL"
                onClick={() => this.clickbtnRotateLeft()}
              ></div>
            </li>
            <li>
              <div
            ...
            <li>
              <div
                ...
                onClick={() => this.clickbtnShowImageEditor()}
              ></div>
            </li>
            <li
              style={{
