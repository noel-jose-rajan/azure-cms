...
export const correspondenceDTOSchema = z.object({
  ...
  corrId: z.string(), // need to delete if all migrations are completed
  ...
  workFlowIntaited: z.boolean().or(z.string()),
  receivingOrganizationUnitsCodes: z.array(z.string()).or(z.array(z.number())),
...
export const correspondenceSchema = z.object({
  ...
  genericActionDTO: z.object({
    ...
    approveAndForwardUser: z.any().nullable(),
    mangerInitiator: z.boolean().nullable(),
    sendForReviewer: z.string().nullable(),
  }),
});
