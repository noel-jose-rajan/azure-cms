...
import {
  AdminDelegationSearch,
  AdminSearchDelegationPayload,
  searchAdminDelegation,
} from "./service";
...
const Delegation = () => {
  ...
  const [data, setData] = useState<AdminDelegationSearch[]>([]);
  ...
  const handleSearch = async (page = 1) => {
    try {
      const body: AdminSearchDelegationPayload = {
        ...getValues(),
        is_arabic: !isEnglish,
      };
      const res = await searchAdminDelegation(page, body);
