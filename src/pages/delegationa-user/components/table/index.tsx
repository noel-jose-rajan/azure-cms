...
import { UserDelegationSearch } from "../../service";

type Props = {
  data: UserDelegationSearch[];
...
const DelegationTable = ({
  ...
  const columns: TableColumnsType<UserDelegationSearch> = [
    {
      width: 150,
        ...
        return (
          ...
          >
            ...
            <Button
              type="link"
              size="small"
              onClick={() => navigate("/user/delegation/" + id)}
            >
              <InfoCircleFilled />
            </Button>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        <ActionMenuItem
          onClick={() => navigate("/user/delegation/create")}
          isActive
          label={labels.btn.add_new}
          type="add"
        />
      </Col>
      <TableComponent<UserDelegationSearch>
